...
class TestMetaProcessMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Define the s3 access keys as environment variables
        ...
        # Create S3BucketConnector instance
    ...
    def test_update_meta_file_no_meta_file(self):
        """
        Test update_meta_file method with no meta file
        """
        # Expected results
        date_list_exp = ['2022-12-20', '2022-12-21']
    ...
    def test_update_meta_file_empty_date_list(self):
        """
        Test update_meta_file method when argument extract_date_list is empty
        """
        # Expected results
        return_exp = True
    ...
    def test_update_meta_file_meta_file_ok(self):
        """
        Tests update_meta_file method with valid meta_file
        """
        # Expected results
        date_list_old = ['2022-12-18', '2022-12-19']
        date_list_new = ['2022-12-20', '2022-12-21']
    ...
    def test_update_meta_file_meta_file_wrong(self):
        """
        Tests update_meta_file method when with wrong meta file
        """
        # Expected results
        date_list_old = ['2022-12-18', '2022-12-19']
        date_list_new = ['2022-12-20', '2022-12-21']
    ...
    def test_return_date_list_no_meta_file(self):
        """
        Tests return_date_list method with no meta file
        """
        # Expected results
        date_list_exp = [
    ...
    def test_return_date_list_meta_file_ok(self):
        """
        Tests return_date_list method with valid meta file
        """
        # Expected results
        min_date_exp = [
    ...
    def test_return_date_list_meta_file_wrong(self):
        """
        Tests return_date_list method with wrong meta file
        """
        # Test init
        meta_key = 'meta.csv'
        meta_content = (
    ...
    def test_return_date_list_empty_date_list(self):
        """
        Tests return_date_list method when there are no dates to be returned
        """
        # Expected results
        min_date_exp = '9999-01-01'
        date_list_exp = []
        # Test init
        meta_key = 'meta.csv'
        meta_content = (
