"""
Intergration TestXetraETLMethods
"""
import unittest
...
class IntTestXetraETLMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s3_bucket_name_src = 'xetra-probe-int-test-src'
        self.s3_bucket_name_trg = 'xetra-probe-int-test-trg'
        ...
        # Create a list of dates from last 8 days.
    ...
    def test_int_etl_report1(self):
        """
        Integration tests for etl_report1 method
        """
        # Expected results
